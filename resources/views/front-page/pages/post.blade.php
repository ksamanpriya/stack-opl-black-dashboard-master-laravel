...
@section('title','Stack - Bootstrap 4 Business Template')
@section('content')
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-12">
                    <div class="breadcrumb-wrapper text-center">
                        <h2>Single Blog</h2>
                        <p><a href="{{route('welcome')}}">Home </a>/ Single Blog</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-md-12 col-xs-12">
                    <div class="blog-post">
                        <div class="post-thumb">
                            <img src="{{asset('front-page/img/blog/blog-1-big.jpg')}}" alt="">
                        </div>
                        ...
                        <ul class="comment-list">
                            <li class="comment">
                                <div class="the-comment">
                                    <div class="avatar">
                                        <img src="{{asset('front-page/img/blog/avater-1.jpg')}}" alt="">
                                    </div>
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="the-comment">
                                            <div class="avatar">
                                                <img src="{{asset('front-page/img/blog/avater-2.jpg')}}" alt="">
                                            </div>
                                            <div class="comment-box">
                                                <div class="comment-author">
                            ...
                            <ul class="latest-post">
                                <li class="single-latest-post">
                                    <div class="latest-post-img">
                                        <a href="#"><img src="{{asset('front-page/img/blog/1.jpg')}}" class="img-fluid" alt="Blog-image"></a>
                                    </div>
                                    <h5><a href="{{route('post')}}">Awesome Blog Title</a></h5>
                                    <p><a href="#">12 Feb, 2020</a></p>
                                </li>
                                <li class="single-latest-post">
                                    <div class="latest-post-img">
                                        <a href="#"><img src="{{asset('front-page/img/blog/2.jpg')}}" class="img-fluid" alt="Blog-image"></a>
                                    </div>
                                    <h5><a href="{{route('post')}}">Awesome Blog Title</a></h5>
                                    <p><a href="#">12 Feb, 2020</a></p>
                                </li>
                                <li class="single-latest-post">
                                    <div class="latest-post-img">
                                        <a href="#"><img src="{{asset('front-page/img/blog/3.jpg')}}" class="img-fluid" alt="Blog-image"></a>
                                    </div>
                                    <h5><a href="{{route('post')}}">Awesome Blog Title</a></h5>
                                    <p><a href="#">12 Feb, 2020</a></p>
                                </li>
