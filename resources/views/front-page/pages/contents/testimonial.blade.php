                ...
                <div id="testimonials" class="owl-carousel wow fadeInUp" data-wow-delay="1.2s">
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{asset('front-page/img/testimonial/img1.jpg')}}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{asset('front-page/img/testimonial/img2.jpg')}}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{asset('front-page/img/testimonial/img3.jpg')}}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{asset('front-page/img/testimonial/img4.png')}}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{asset('front-page/img/testimonial/img5.png')}}" alt="">
                            </div>
                            <div class="info">
